Plugin to Use Pandoc with open journal systems. Requires Pandoc.exe to be available from the user that hosts the webserver/ojs as well as writing rights for the given directory.
